  ...
  return (
    <section>
      <div className="flex pt-[120px]">
        ...
        <div className="bgImage2 min-[1000px]:right-0 h-[800px] min-[1000px]:h-[530px] w-full bg-no-repeat bg-center min-[1000px]:bg-right max-[1000px]:mt-[70px]"></div>
      </div>
      <div className="flex flex-col gap-20 py-20 px-[130px] max-md:px-0 bg-color6">
        <div className="flex flex-row-reverse max-[1300px]:flex-col gap-5">
          ...
          <div className="w-[580px] h-[500px] max-md:h-[450px] max-md:bg-top bg-cover bg-no-repeat max-xl:w-[768px] max-md:w-full flex-none bgPhoto1Business">
        ...
        <div className="flex flex-row max-[1300px]:flex-col gap-5">
          ...
          <div className="w-[580px] h-[500px] max-md:h-[450px] max-md:bg-top bg-cover bg-no-repeat max-xl:w-[768px] max-md:w-full flex-none bgPhoto2Business"></div>
        </div>
        <div className="flex flex-row-reverse max-[1300px]:flex-col gap-5">
          ...
          <div className="w-[580px] h-[500px] max-md:h-[450px] max-md:bg-top bg-cover bg-no-repeat max-xl:w-[768px] max-md:w-full flex-none bgPhoto3Business relative">
